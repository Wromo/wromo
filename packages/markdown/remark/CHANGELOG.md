...
- 397d8f3d: Upgrade `@wromojs/markdown-support` dependencies. The `remark-rehype@9` upgrade enables accessible footnotes with `remark-footnotes`.
...
- f83407e: Expose `html` to `Wromo.fetchContent` (#571)
