...
// and was adapted to use our fork `@wromojs/micromark-extension-mdx-jsx`
// instead of `micromark-extension-mdx-jsx` to allow some extended syntax.
// See `@wromojs/micromark-extension-mdx-jsx` on NPM for more details.
// Also, support for ESM imports & exports in Markdown content was removed.

import { mdxJsx } from '@wromojs/micromark-extension-mdx-jsx';
