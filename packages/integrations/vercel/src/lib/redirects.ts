import type { WromoConfig, RouteData, RoutePart } from 'wromo';
...
// Copied from /home/juanm04/dev/misc/wromo/packages/wromo/src/core/routing/manifest/create.ts
// 2022-04-26
...
export function getRedirects(routes: RouteData[], config: WromoConfig): VercelRoute[] {
