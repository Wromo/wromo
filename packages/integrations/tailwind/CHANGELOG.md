...
- [#3099](https://github.com/withwromo/wromo/pull/3099) [`254a8f37`](https://github.com/withwromo/wromo/commit/254a8f37499863c5684fb0d5b0f59a8cee093d0b) Thanks [@tony-sull](https://github.com/tony-sull)! - Removes the `applyWromoPreset` integration option. Tailwind presets can be disabled directly from the Tailwind config file by including `presets: []`
...
- [`c05a544a`](https://github.com/withwromo/wromo/commit/c05a544acd5c9dd4f57b53ce21e82141212a3c2c) Thanks [@FredKSchott](https://github.com/FredKSchott)! - Update README
...
- [`e425f896`](https://github.com/withwromo/wromo/commit/e425f896b668d98033ad3b998b50c1f28bc7f6ee) Thanks [@FredKSchott](https://github.com/FredKSchott)! - Adds an option to opt-out of the default base styles for the Tailwind integration

## 0.0.2

### Patch Changes

- [#2831](https://github.com/withwromo/wromo/pull/2831) [`5315c3f7`](https://github.com/withwromo/wromo/commit/5315c3f7bc0649f9788713f689f484e223bc0ca6) Thanks [@bholmesdev](https://github.com/bholmesdev)! - Add support for tailwind config files. These can either be a standard `tailwind.config.js|cjs|mjs`, or a custom filename as specified in your integration config.
