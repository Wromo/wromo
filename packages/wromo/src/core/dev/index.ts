...
/** `wromo dev` */
export default async function dev(config: WromoConfig, options: DevOptions): Promise<DevServer> {
	...
	const viteConfig = await createVite(
		{
			...
			optimizeDeps: {
				include: [
					'wromo/client/idle.js',
					'wromo/client/load.js',
					'wromo/client/visible.js',
					'wromo/client/media.js',
					'wromo/client/only.js',
					...rendererClientEntries,
				],
			},
		},
		{ wromoConfig: config, logging: options.logging, mode: 'dev' }
	);
