...
import { WromoCheck, DiagnosticSeverity } from '@wromojs/language-server';
...
export async function check(wromoConfig: WromoConfig) {
	const root = wromoConfig.root;
	let checker = new WromoCheck(root.toString());
