...
- [#3696](https://github.com/Wromo/wromo/pull/3696) [`3daaf510`](https://github.com/Wromo/wromo/commit/3daaf510ea767fba47ef52d2253b6221967f3b53) Thanks [@matthewp](https://github.com/matthewp)! - Support for streaming responses
  ...
  As part of this Wromo also now supports async iterables within its templates. This means you can do this:
...
* [#2548](https://github.com/Wromo/wromo/pull/2548) [`ba5e2b5e`](https://github.com/Wromo/wromo/commit/ba5e2b5e6c20207955991775dc4aa8879331542c) Thanks [@matthewp](https://github.com/matthewp)! - Experimental SSR Support
  ...
  - This adds a new `--experimental-ssr` flag to `wromo build` which will result in `dist/server/` and `dist/client/` directories.
  - SSR can be used through this API:

    ```js
    import { createServer } from 'http';
    import { loadApp } from 'wromo/app/node';
...
- Updated dependencies [[`a907a73b`](https://github.com/Wromo/wromo/commit/a907a73b8cd14726d158ea460932f9cd8891923a), [`cfeaa941`](https://github.com/Wromo/wromo/commit/cfeaa9414acdecec6f5d66ee0e33fe4fde574eee), [`2bc91543`](https://github.com/Wromo/wromo/commit/2bc91543ceeb5f3dd45e201bf75d79f186e85141), [`6fe1b027`](https://github.com/Wromo/wromo/commit/6fe1b0279fce5a7a0e90ff79746ea0b641da3e21), [`2bc91543`](https://github.com/Wromo/wromo/commit/2bc91543ceeb5f3dd45e201bf75d79f186e85141), [`d71c4620`](https://github.com/Wromo/wromo/commit/d71c46207af40de6811596ca4f5e10aa9006377b)]:
  ...
  - @wromojs/renderer-vue@0.4.0
  - @wromojs/markdown-remark@0.6.1
...
- Updated dependencies [[`a907a73b`](https://github.com/Wromo/wromo/commit/a907a73b8cd14726d158ea460932f9cd8891923a)]:
  ...
  - @wromojs/renderer-vue@0.4.0-next.0
...
- Updated dependencies [[`45cea6ae`](https://github.com/Wromo/wromo/commit/45cea6aec5a310fed4cb8da0d96670d6b99a2539)]:
  ...
  - @wromojs/renderer-svelte@0.3.0
  - @wromojs/renderer-vue@0.3.0
  - @wromojs/markdown-remark@0.6.0
...
- fad6bd09: Fixes use of `PUBLIC_` to reference env vars
  ...
  Previously `PUBLIC_` worked in server-only components such as .wromo components. However if you had a client-side component you had to use `VITE_`. This was a bug with our build that is now fixed.
...
- fc5f4163: Fix regression with `wromo build` 404.wromo output
- Updated dependencies [679d4395]
  - @wromojs/markdown-remark@0.5.0
...
- e6aaeff5: Wromo 0.21 is here! [Read the complete migration guide](https://docs.wromo.build/migration/0.21.0/).
...
- Updated dependencies [e6aaeff5]
- Updated dependencies [e6aaeff5]
  - @wromojs/renderer-preact@0.3.0
  - @wromojs/renderer-react@0.3.0
  - @wromojs/renderer-svelte@0.2.0
  - @wromojs/renderer-vue@0.2.0
  - @wromojs/markdown-remark@0.4.0
  - @wromojs/prism@0.3.0
...
- 00d2b625: Add Vite dependencies to wromo
- Updated dependencies [00d2b625]
  - @wromojs/markdown-remark@0.4.0-next.2
...
- 3b511059: Fix for OSX .wromo file corruption
...
- Updated dependencies [8986d33b]
  - @wromojs/renderer-vue@0.2.0-next.2
...
- b958088c: Make wromo-root be a display: contents element
...
- fca1a99d: Provides first-class support for a site deployed to a subpath
  ...
  Now you can deploy your site to a subpath more easily. Wromo will use your `buildOptions.site` URL and host the dev server from there.

  If your site config is `http://example.com/blog` you will need to go to `http://localhost:3000/blog/` in dev and when using `wromo preview`.
...
- Updated dependencies [3cd1458a]
  - @wromojs/renderer-preact@0.3.0-next.1
  - @wromojs/renderer-react@0.3.0-next.1
  - @wromojs/renderer-svelte@0.2.0-next.1
  - @wromojs/renderer-vue@0.2.0-next.1
...
- Updated dependencies [7eaabbb0]
  - @wromojs/markdown-remark@0.4.0-next.1

## 0.21.0-next.2

### Patch Changes

- fbae2bc5: **Improve support for Wromo config files.**

In addition to properly loading `.cjs` and `.js` files in all cases, Wromo now supports `wromo.config.ts` files.

For convenience, you may now also move your `wromo.config.js` file to a top-level `config/` directory.
...
- d84bfe71: Wromo 0.21 Beta release! This introduces the new version of Wromo that includes:

  - A new, faster, Go-based compiler
  - A runtime backed by Vite, with faster dev experience
  - New features

  See more at https://wromo.build/blog/wromo-021-preview/
...
- Updated dependencies [d84bfe71]
- Updated dependencies [d84bfe71]
  - @wromojs/prism@0.3.0-next.0
  - @wromojs/markdown-remark@0.4.0-next.0
  - @wromojs/renderer-preact@0.3.0-next.0
  - @wromojs/renderer-react@0.3.0-next.0
  - @wromojs/renderer-svelte@0.2.0-next.0
  - @wromojs/renderer-vue@0.2.0-next.0
...
- dbd2f507: Adds the `wromo check` command

  This adds a new command, `wromo check` which runs diagnostics on a project. The same diagnostics run within the Wromo VSCode plugin! Just run:
...
- Updated dependencies [97d37f8f]
  - @wromojs/renderer-preact@0.2.2
  - @wromojs/renderer-react@0.2.1
  - @wromojs/renderer-svelte@0.1.2
  - @wromojs/renderer-vue@0.1.8
...
- b03f8771: Fix wromo bin bug in some pre-ESM versions of Node v14.x
- Updated dependencies [b03f8771]
- Updated dependencies [b03f8771]
  - @wromojs/markdown-support@0.3.1
...
- 290f2032: Fix knownEntrypoint warning for \_\_wromo_hoisted_scripts.js
...
- Updated dependencies [5d2ea578]
  - @wromojs/parser@0.20.2

## 0.20.1

### Patch Changes

- ff92be63: Add a new "wromo preview" command
...
- affcd04f: **[BREAKING CHANGE]** stop bundling, building, and processing public files. This fixes an issue where we weren't actually honoring the "do not process" property of the public directory.
  ...
  If you were using the `public/` directory to build files (for example, like `public/index.scss`) then you can expect this to no longer work. As per the correct Wromo documentation.

### Patch Changes

- Updated dependencies [397d8f3d]
  - @wromojs/markdown-support@0.3.0
...
- 9482fade: Makes sure Wromo.resolve works in nested component folders
...
- Updated dependencies [a421329f]
  - @wromojs/markdown-support@0.2.4
...
- 239065e2: **[BREAKING]** Replace the Collections API with new file-based routing.
  ...
  If you have trouble upgrading, reach out on https://wromo.build/chat
  ...
  - https://wromo-docs-git-main-pikapkg.vercel.app/core-concepts/routing
  - https://wromo-docs-git-main-pikapkg.vercel.app/guides/pagination
  - https://wromo-docs-git-main-pikapkg.vercel.app/guides/rss
  - https://wromo-docs-git-main-pikapkg.vercel.app/reference/api-reference#getstaticpaths

- 239065e2: Adds support for Wromo.resolve
...
- 239065e2: Adds support for client:only hydrator
  ...
  **Note** If more than one renderer is included in your Wromo config, you need to include a hint to determine which renderer to use. Renderers will be matched to the name provided in your Wromo config, similar to `<MyComponent client:only="@wromojs/renderer-react" />`. Shorthand can be used for `@wromojs` renderers, i.e. `<MyComponent client:only="react" />` will use `@wromojs/renderer-react`.
  ...
  /**
   * If multiple renderers are included in the Wromo config,
...
- 618ea3a8: Properly escapes script tags with nested client:load directives when passing Wromo components into framework components via props. Browsers interpret script end tags in strings as script end tags, resulting in syntax errors.
- 939b9d01: Allow dev server port to be set by `PORT` environment variable
- Updated dependencies [1339d5e3]
  - @wromojs/renderer-vue@0.1.7
...
- 03349560: Makes Wromo.request available in Wromo components
...
- Updated dependencies [a1491cc6]
  - @wromojs/parser@0.18.5
  - @wromojs/renderer-vue@0.1.6
...
- Updated dependencies [460e625]
  - @wromojs/markdown-support@0.2.3
...
- Updated dependencies [7015356]
  - @wromojs/markdown-support@0.2.2
...
- Updated dependencies [fdb1c15]
  - @wromojs/markdown-support@0.2.1
  - @wromojs/renderer-vue@0.1.5
...
- e90615f: Fixes warnings for Wromo internals for fetch-content and slots
...
- f67e8f5: New Collections API (createCollection)
  ...
  BREAKING CHANGE: The expected return format from createCollection() has been changed. Visit https://docs.wromo.build/core-concepts/collections to learn the new API.
...
- 0340b0f: Adds support for the client:media hydrator
  ...
  Since Wromo components can have expressions, you can move common media queries to a module for sharing. For example here are defining:
...
- e89a99f: This includes the props passed to a hydration component when generating the hash/id. This prevents multiple instances of the same component with differing props to be treated as the same component when hydrated by Wromo.
- b8af49f: Added sass support
- a7e6666: compile javascript to target Node v12.x
- fb8bf7e: Allow multiple Wromo servers to be running simultaneously by choosing random ports if the defaults are taken.
...
- 8f4562a: Improve slot support, adding support for named slots and fallback content within `slot` elements.
  ...
  See the new [Slots documentation](https://docs.wromo.build/core-concepts/wromo-components/#slots) for more information.

- 4a601ad: Restores the ability to use Fragment in wromo components
...
- 007c220: Remove custom Wromo.fetchContent() glob implementation, use `import.meta.globEager` internally instead.
...
- Updated dependencies [b85e68a]
  - @wromojs/parser@0.18.0
  - @wromojs/renderer-preact@0.2.0
  - @wromojs/renderer-react@0.2.0
  - @wromojs/renderer-vue@0.1.4
...
- Updated dependencies [1f79144]
  - @wromojs/renderer-vue@0.1.4-next.0
...
- Add support for [Solid](https://www.solidjs.com/) when using the new [`@wromojs/renderer-solid`](https://npm.im/@wromojs/renderer-solid) package.
...
- Updated dependencies [bd18e14]
- Updated dependencies [bd18e14]
  - @wromojs/renderer-preact@0.2.0-next.0
  - @wromojs/renderer-react@0.2.0-next.0
...
- 42a1fd7: Add command line flag `--silent` to wromo to set no output.
...
- d396943: Add support for [`remark`](https://github.com/remarkjs/remark#readme) and [`rehype`](https://github.com/rehypejs/rehype#readme) plugins for both `.md` pages and `.wromo` pages using the [`<Markdown>`](/docs/guides/markdown-content.md) component.

  For example, the `wromo.config.mjs` could be updated to include the following. [Read the Markdown documentation](/docs/guides/markdown-content.md) for more information.

  > **Note** Enabling custom `remarkPlugins` or `rehypePlugins` removes Wromo's built-in support for [GitHub-flavored Markdown](https://github.github.com/gfm/) support, [Footnotes](https://github.com/remarkjs/remark-footnotes) syntax, [Smartypants](https://github.com/silvenon/remark-smartypants). You must explicitly add these plugins to your `wromo.config.mjs` file, if desired.
...
- Updated dependencies [f83407e]
  - @wromojs/markdown-support@0.2.0
...
- e28d5cb: Improve error handling within `.wromo` files (#526)
...
- a136c85: **This is a breaking change!**
  ...
  Wromo props are now accessed from the `Wromo.props` global. This change is meant to make prop definitions more ergonomic, leaning into JavaScript patterns you already know (destructuring and defaults). Wromo components previously used a prop syntax borrowed from [Svelte](https://svelte.dev/docs#1_export_creates_a_component_prop), but it became clear that this was pretty confusing for most users.

  ```diff
   ---
  + const { text = 'Hello world!' } = Wromo.props;
  ...
  [Read more about the `.wromo` syntax](https://docs.wromo.build/syntax/#data-and-props)

  ***

  ### How do I define what props my component accepts?

  Wromo frontmatter scripts are TypeScript! Because of this, we can leverage TypeScript types to define the shape of your props.
  ...
  const { text = 'Hello world!' } = Wromo.props as Props;
  ---
  ```

  > **Note** Casting `Wromo.props as Props` is a temporary workaround. We expect our Language Server to handle this automatically soon!
  ...
  const { text = 'Hello world!', ...props } = Wromo.props as Props;
  ---
  ```

  ### What about prop validation?

  We considered building prop validation into Wromo, but decided to leave that implementation up to you! This way, you can use any set of tools you like.
...
- Updated dependencies [0abd251]
  - @wromojs/renderer-preact@0.1.3
  - @wromojs/renderer-react@0.1.3
  - @wromojs/renderer-vue@0.1.3
...
- Updated dependencies [f9f2da4]
  - @wromojs/parser@0.13.9
  - @wromojs/prism@0.2.2
  - @wromojs/markdown-support@0.1.2
...
- Updated dependencies [9d4a40f]
  - @wromojs/renderer-preact@0.1.2
  - @wromojs/renderer-react@0.1.2
...
- Updated dependencies [ab2972b]
  ...
  - @wromojs/prism@0.2.1
  - @wromojs/renderer-preact@0.1.1
  - @wromojs/renderer-react@0.1.1
  - @wromojs/renderer-svelte@0.1.1
  - @wromojs/renderer-vue@0.1.2
...
- 21b0c73: Removes some warnings that are internal to Wromo
...
- 522c873: Fixes bug where wromo build would fail when trying to log
...
- 50e6f49: Fixes issues with using wromo via the create script
- Updated dependencies [50e6f49]
  - @wromojs/markdown-support@0.1.1
...
- 8ff7998: Enabled Snowpack's built-in HMR engine for Wromo pages
- 643c880: **This is a breaking change**

  Updated the rendering pipeline for `wromo` to truly support any framework.

  For the vast majority of use cases, `wromo` should _just work_ out of the box. Wromo now depends on `@wromojs/renderer-preact`, `@wromojs/renderer-react`, `@wromojs/renderer-svelte`, and `@wromojs/renderer-vue`, rather than these being built into the core library. This opens the door for anyone to contribute additional renderers for Wromo to support their favorite framework, as well as the ability for users to control which renderers should be used.
  ...
  **Breaking Changes**
  ...
  - To improve compiler performance, improve framework support, and minimize JS payloads, any children passed to hydrated components are automatically wrapped with an `<wromo-fragment>` element.

### Patch Changes

- 3d20623: Fixed a bug where Wromo did not conform to JSX Expressions' [`&&`](https://reactjs.org/docs/conditional-rendering.html#inline-if-with-logical--operator) syntax.
...
- c9d833e: Fixed a number of bugs and re-enabled the `@wromojs/renderer-vue` renderer
- ce30bb0: Temporarily disable `@wromojs/renderer-vue` while we investigate an issue with installation
- addd67d: Rename `wromoConfig` to `pages` in config. Docs updated.
...
- Updated dependencies [c9d833e]
  - @wromojs/renderer-preact@0.1.0
  - @wromojs/renderer-react@0.1.0
  - @wromojs/renderer-svelte@0.1.0
  - @wromojs/renderer-vue@0.1.0
  - wromo-parser@0.12.0
...
- Updated dependencies [643c880]
  - @wromojs/renderer-preact@0.1.0-next.0
  - @wromojs/renderer-react@0.1.0-next.0
  - @wromojs/renderer-svelte@0.1.0-next.0
  - @wromojs/renderer-vue@0.1.0-next.0

## 0.11.0

### Minor Changes

- 19e20f2: Add Tailwind JIT support for Wromo

### Patch Changes

- c43ee95: Bugfix: CSS bundling randomizes order
- 9cdada0: Fixes a few edge case bugs with Wromo's handling of Markdown content
- Updated dependencies [9cdada0]
  - wromo-parser@0.11.0

## 0.10.0

`wromo` has been bumped to `0.10.0` to avoid conflicts with the previously published `wromo` package (which was graciously donated to us at `v0.9.2`).

### Minor Changes

- b3886c2: Enhanced **Markdown** support! Markdown processing has been moved from `micromark` to `remark` to prepare Wromo for user-provided `remark` plugins _in the future_.

  This change also introduces a built-in `<Markdown>` component for embedding Markdown and any Wromo-supported component format inside of `.wromo` files. [Read more about Wromo's Markdown support.](https://docs.wromo.build/markdown/)
...
- 7184149: Added canonical URL and site globals for .wromo files
