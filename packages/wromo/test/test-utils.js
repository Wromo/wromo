 ...
 * @typedef {import('../src/@types/wromo').WromoConfig} WromoConfig
...
/**
 * Load Wromo fixture
 * @param {WromoConfig} inlineConfig Wromo config partial (note: must specify `root`)
...
export async function loadFixture(inlineConfig) {
	...
	/** @type {import('@wromojs/telemetry').WromoTelemetry} */
	const telemetry = {
		record() {
...
const cliPath = fileURLToPath(new URL('../wromo.js', import.meta.url));

/** Returns a process running the Wromo CLI. */
