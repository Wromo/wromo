...
describe('Vue component', () => {
	...
	describe('build', () => {
		...
		it('Can load Vue', async () => {
			...
			// test 2: renders 3 <wromo-island>s
			expect($('wromo-island')).to.have.lengthOf(6);

			// test 3: all <wromo-island>s have uid attributes
			expect($('wromo-island[uid]')).to.have.lengthOf(6);
			...
			const uniqueRootUIDs = $('wromo-island').map((i, el) => $(el).attr('uid'));
