...
export function rollupPluginWromoBuildCSS(options: PluginOptions): VitePlugin[] {
	...
	const CSS_PLUGIN_NAME = '@wromojs/rollup-plugin-build-css';
	const CSS_MINIFY_PLUGIN_NAME = '@wromojs/rollup-plugin-build-css-minify';
				...
				if (options.target === 'server') {
					for (const [, output] of Object.entries(bundle)) {
						if (output.type === 'asset') {
							...
							// about it being a CSS module. We need to keep these chunks around because Wromo
