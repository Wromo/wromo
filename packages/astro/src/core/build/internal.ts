...
export interface BuildInternals {
	...
	// A mapping of specifiers like wromo/client/idle.js to the hashed bundled name.
...
export function createBuildInternals(): BuildInternals {
	...
	const wromoStyleMap = new Map<string, string>();
	// This is a virtual JS module that imports all dependent styles for a page.
	const wromoPageStyleMap = new Map<string, string>();
