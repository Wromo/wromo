...
describe('jsx-runtime', () => {
	...
	it('Can load Preact component inside Wromo JSX', async () => {
	...
	it('Can load React component inside Wromo JSX', async () => {
		const html = await fixture.readFile('/frameworks/index.html');
		const $ = cheerio.load(html);
	...
	it('Can load Solid component inside Wromo JSX', async () => {
		const html = await fixture.readFile('/frameworks/index.html');
		const $ = cheerio.load(html);
	...
	it('Can load Svelte component inside Wromo JSX', async () => {
		const html = await fixture.readFile('/frameworks/index.html');
		const $ = cheerio.load(html);
	...
	it('Can load Vue component inside Wromo JSX', async () => {
		const html = await fixture.readFile('/frameworks/index.html');
		const $ = cheerio.load(html);
