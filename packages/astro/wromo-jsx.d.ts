...
declare namespace wromoHTML.JSX {
	...
	type WromoBuiltinProps = import('wromo').WromoBuiltinProps;
	type WromoBuiltinAttributes = import('wromo').WromoBuiltinAttributes;
	type WromoDefineVarsAttribute = import('wromo').WromoDefineVarsAttribute;
	type WromoScriptAttributes = import('wromo').WromoScriptAttributes & WromoDefineVarsAttribute;
	type WromoStyleAttributes = import('wromo').WromoStyleAttributes & WromoDefineVarsAttribute;

	// Certain Wromo methods returns WromoComponent using WromoComponentFactory
	// The language-server does not really like this because it expects Elements to
	// all be compatible with HTMLElement so we'll add WromoComponentFactory as a valid element type
	type WromoComponent = import('wromo').WromoComponentFactory;
	type Element = HTMLElement | WromoComponent;
	...
	interface IntrinsicElements {
		...
		script: HTMLProps<HTMLElement> & WromoScriptAttributes;
		...
		style: HTMLProps<HTMLStyleElement> & WromoStyleAttributes;
